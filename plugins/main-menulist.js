...
rows: [
{title: `${emot} All`, rowId: ".? all", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀɴ Sᴇᴍᴜᴀ ᴄᴏᴍᴍᴀɴᴅ BOT"}
{title: `${emot} Rpg`, rowId: ".? rpg", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀɴ Mᴇɴᴜ Rᴘɢ"},
...
{title: `${emot} Virus`, rowId: ".? virus", description: "Hᴜsᴜs Oᴡɴᴇʀ ZʏᴋᴏBᴏᴛᴢ-MD"},
]
}, {
