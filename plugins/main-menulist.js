...
let tett = `
`
let fot = `📮 *Note:* Jika menemukan bug, error atau kesulitan dalam penggunaan silahkan laporkan/tanyakan kepada Owner
`
const listMessage = {
text: tett,
footer: fot,
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: sgc,
    ...
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/434beb70c9b14238ab16d.jpg')).buffer(),
    sourceUrl: sgc
 	  /*   sourceUrl: sig,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
...
let almenu = `╭─────═[ INFO USER ]═─────⋆
│╭───────────────···
┴│☂︎ *Name:* ${name}
${emot}│☂︎ *Tag:* ${tagnya}
${emot}│☂︎ *Premium:* ${usrs.premiumTime > 1 ? '✔ Ya': '✘ Tidak'}
${emot}│☂︎ *Limit:* ${usrs.limit}
${emot}│☂︎ *Money:* ${money}
${emot}│☂︎ *Role:* ${usrs.role} 
${emot}│☂︎ *Level:* ${usrs.limit}
${emot}│☂︎ *Xp:* 
┬│☂︎ *Total Xp:* 
│╰────────────────···
┠─────═[ TODAY ]═─────⋆
...
│╭────────────────···
┴│☂︎ *Nama Bot:* ${namebot}
${emot}│☂︎ *All Fitur: ${totalf}
${emot}│☂︎ *Oᴡɴᴇʀ: ${ownernya}
${emot}│☂︎ *Mode:* ${mode}
${emot}│☂︎ *Prefix:* ${_p}
