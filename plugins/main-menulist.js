...
let arrayMenu = ['all', 'anime', 'update', 'maker', 'berita', 'edukasi', 'news', 'random', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database","quran', 'vote', 'virus', 'nsfw', 'audio', 'audioanime', 'jadibot', 'info', 'owner', 'nocategory']
...
rows: [
{title: `${emot} All`, rowld: ".? all", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀɴ sᴇᴍᴜᴀ ᴄᴏᴍᴍᴀɴᴅ BOT"},
...
{title: `${emot} Audio Anime`, rowId: ".? audioanime", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀɴ Mᴇɴᴜ Aᴜᴅɪᴏ Aɴɪᴍᴇ"},
...
{title: `${emot} Virus`, rowId: ".? virus", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀɴ Mᴇɴᴜ ᴠɪʀᴜs Hᴜsᴜs Oᴡɴᴇʀ ZʏᴋᴏBᴏᴛᴢ-MD"},
]
}, {
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: sgc,
    ...
    title: "≪ Jᴏɪɴ Sɪɴɪ Cᴜʏ ⋟",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/08bcb5aa2b3f591c366bd.jpg')).buffer(),
    sourceUrl: sgc
 	  /*   sourceUrl: sig,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
